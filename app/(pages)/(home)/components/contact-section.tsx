        ...
        <section className="min-h-screen bg-[#fefefe] flex items-center px-[clamp(1.5rem,6vw,6rem)] py-[clamp(4rem,8vw,8rem)]">
            <div className="w-full max-w-275 mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-[clamp(3rem,6vw,7rem)] items-start">
                    ...
                    <div className="pt-2">
                        <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#0a0a0a]/50 mb-6">
                            — Contact
                        </p>

                        <h2 className="font-serif text-[clamp(42px,5.5vw,72px)] font-normal italic leading-[1.05] text-[#0a0a0a] mb-7">
                            Let&apos;s make something{' '}
                            <span className="text-[#0a0a0a]/25">interesting</span>
                        </h2>

                        <p className="font-mono text-[13px] leading-[1.8] text-[#0a0a0a]/45 mb-12 max-w-[320px]">
                            ...
                            {[
                                ...
                                <div key={label}>
                                    ...
                                    <p className={`font-mono text-[13px] tracking-wide ${
                                        highlight ? 'text-lime-accent font-medium' : 'text-[#0a0a0a]/65'
                                    }`}>
                                        {value}
                                    </p>
                                </div>
